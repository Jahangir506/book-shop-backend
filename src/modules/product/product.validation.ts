...
const productValidationSchema = z.object({
    ...
    category: z.enum(['Fiction', 'Science', 'SelfDevelopment', 'Religious', 'English', 'Programming'], {
    ...
    inStock: z.boolean().refine(value => typeof value === 'boolean', { message: 'InStock status is required' }),
});
